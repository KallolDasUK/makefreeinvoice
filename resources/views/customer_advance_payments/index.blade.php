                ...
                <table class="table table-striped table-sm">
                    ...
                    @foreach($customerAdvancePayments as $customerAdvancePayment)
                        <tr>
                            ...
                            <td>{{ optional($customerAdvancePayment->ledger)->id }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-sm float-right " role="group">
                                        <a href="{{ route('customer_advance_payments.customer_advance_payment.show', $customerAdvancePayment->id ) }}"title="Show Customer Advance Payment">
                                            <i class="fa fa-eye text-info" aria-hidden="true"></i>
                                        </a>
                                        <a href="{{ route('customer_advance_payments.customer_advance_payment.edit', $customerAdvancePayment->id ) }}" class="mx-4" title="Edit Customer Advance Payment">
                                            <i class="fas fa-edit text-primary" aria-hidden="true"></i>
                                        </a>

                                        <button type="submit" style="border: none;background: transparent"  title="Delete Customer Advance Payment" onclick="return confirm(&quot;Click Ok to delete Customer Advance Payment.&quot;)">
