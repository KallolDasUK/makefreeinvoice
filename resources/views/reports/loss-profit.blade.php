                ...
                <div class="row">
                    <div class="col">
                        <table class=" table mb-0  table-head-custom table-vertical-center ">
                            ...
                            <tr>
                                <td style="color: black!important;" class="font-weight-bolder"> GROSS PROFIT</td>
                                <td style="text-align: center;color: black!important;">{{ decent_format_dash($totalIncome) }}</td>
                            </tr>
                    ...
                    <div class="col">
                        <table class=" table mb-0  table-head-custom table-vertical-center ">
                            ...
                            <tr>
                                <td style="color: black!important;" class="font-weight-bolder"> GROSS PROFIT</td>
                                <td style="text-align: center;color: black!important;">{{ decent_format_dash($totalIncome-$totalExpense) }}</td>
                            </tr>
                            </thead>
                        </table>
                    </div>
