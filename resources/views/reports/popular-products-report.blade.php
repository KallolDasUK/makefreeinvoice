...
@section('content')
    ...
    <div class="">
        ...
        <div class="card mb-2">
            <div class="card-body">
                <form action="{{ route('reports.report.popular_products_report') }}">
                        ...
                        <div class="card-body p-0">
                            <table class="table mb-0  table-head-custom table-vertical-center text-center">
                                ...
                                <tr>
                                    ...
                                    <th class="text-left">Sold Quantity</th>
                                ...
                                @foreach($records as $record)
                                    <tr>
                                        ...
                                        <td class="text-left"><b>{{ $record->product_name }}</b></td>
                                        <td class="text-left">{{ $record->sold }}</td>
                                        <td class="text-left">{{ $record->stock }}</td>
                                    </tr>
                                @endforeach
