<!-- Modal-->
<div class="modal fade" id="recordPaymentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Record a payment for this invoice :
                    <strong class="invoice_number"></strong>
                </h5>
            ...
            <form id="recordPaymentForm" action="{{ route('ajax.recordPayment') }}" method="post">
                @csrf
