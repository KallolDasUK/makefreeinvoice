...
@section('content')
    ...
    <div class="text-right">
        <a href="{{ route('purchase_returns.purchase_return.index') }}" class="btn btn-primary  {{  ability(\App\Utils\Ability::PURCHASE_RETURN_READ) }} " title="Show All Invoices">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('purchase_returns.purchase_return.store') }}" accept-charset="UTF-8"
                  id="create_invoice_form" name="create_invoice_form" class="form-horizontal"
                  enctype="multipart/form-data">
                {{ csrf_field() }}
                @include ('purchase_return.form', ['purchase_return' => null])
                ...
                <div class="form-group">
                    <div class="float-right">
                        ...
                        <button class="btn btn-primary btn-lg btn-fw" type="submit">
                            ...
                            <i class="far fa-save"></i> Save Purchase Return
                        </button>
                    </div>
                </div>
