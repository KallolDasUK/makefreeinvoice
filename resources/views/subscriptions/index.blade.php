    ...
    <div class="">
        ...
        <div class="card">
            ...
            <div class="card-body position-relative p-0 rounded-card-top">
                <!--begin::Pricing title-->
                <h3 class="text-center py-10  m-0 rounded-card-top">Transparent &amp; Simple Pricing</h3>
                <!--end::Pricing title-->
                        ...
                        <div class="row align-items-center justify-align-items">
                            ...
                            <div class="col-12 col-lg-4 bg-white border-x-0 border-x-lg border-y border-y-lg-0 p-0">
                                <div class="py-15 px-0 px-lg-5 text-center">
                                    ...
                                    <!--end::Mobile Pricing Table-->
                                    <div class="mt-7">
                                        <button type="button" id="standardPlan"
                                                class="btn btn-primary text-uppercase font-weight-bolder px-15 py-3">
                                            Subscribe
                                        </button>
                                    </div>
                            ...
                            <div class="col-12 col-lg-4  bg-white mb-10 mb-lg-0 p-0">
                                <div class="py-15 px-0 px-lg-5 text-center">
                                    <div class="d-flex flex-center mb-7">
																<span class="svg-icon svg-icon-5x svg-icon-primary">
                                    ...
                                    <!--end::Mobile Pricing Table-->
                                    <div class="mt-7">
                                        <button type="button" id="enterprisePlan"
                                                class="btn btn-primary text-uppercase font-weight-bolder px-15 py-3">
                                            Subscribe
                                        </button>
                                    </div>
...
@section('js')
    <script>
        $(document).ready(function () {
            ...
            $('#standardPlan').on('click', function () {
                $('#subscriptionPaymentModal').modal('show')
            })
            $('#enterprisePlan').on('click', function () {
                $('#subscriptionPaymentModal').modal('show')
            })
