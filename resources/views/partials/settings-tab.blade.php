    ...
    <ul class="nav nav-tabs nav-tabs-line">
        ...
        <li class="nav-item cursor-pointer">
            <a class="nav-link {{ $page === 'shortcuts'?'active':'' }} p-4  {{ ability(\App\Utils\Ability::GENERAL_SETTINGS_READ) }}"
               href="{{ route('shortcuts.shortcut.index') }}">
                ...
                <span class="nav-text font-weight-bolder">Shortcuts</span>
            </a>
        </li>
        ...
        <li class="nav-item cursor-pointer">
            <a class="nav-link {{ $page === 'change_password'?'active':'' }} p-4 "
               href="{{ route('settings.update_password') }}">
                ...
                <span class="nav-text font-weight-bolder">Password</span>
            </a>
        </li>
        <li class="nav-item cursor-pointer">
        ...
        <li class="nav-item cursor-pointer">
            <a class="nav-link {{ $page === 'billings'?'active':'' }} p-4" href="{{ route('subscriptions.settings') }}">
                ...
                <span class="nav-text font-weight-bolder">Subscriptions</span>
            </a>
        </li>
