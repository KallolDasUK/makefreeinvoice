    ...
    <div class="">
        <div class="">
            ...
            <div class="text-center">
                ...
                <form method="POST" action="{!! route('purchase_orders.purchase_order.destroy', $purchase_order->id) !!}"
        ...
        <p class="clearfix"></p>
        @include('partials.purchase_order')
...
@push('js')
    <script>
        ...
        $('#downloadButton').on('click', function () {
            ...
            let invoice_number = "{{ $purchase_order->bill_number??'invoice_invoicepedia' }}"
            var opt = {
