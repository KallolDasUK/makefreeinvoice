    ...
    <div class="card">
            ...
            <div class="float-right">
                ...
                <form method="POST" action="{!! route('categories.category.destroy', $category->id) !!}"
                    ...
                    <div class="btn-group btn-group-sm" role="group">
                        <a href="{{ route('categories.category.index') }}" class="btn btn-primary mr-2"
                           title="Show All Category">
                            <i class=" fas fa-fw fa-th-list" aria-hidden="true"></i>
                            Show All Category
                        </a>

                        <a href="{{ route('categories.category.create') }}" class="btn btn-success mr-2"
                           title="Create New Category">
                            <i class=" fas fa-fw fa-plus" aria-hidden="true"></i>
                            Create New Category
                        </a>

                        <a href="{{ route('categories.category.edit', $category->id ) }}" class="btn btn-primary mr-2"
                           title="Edit Category">
        ...
        <div class="card-body">
            <dl class="dl-horizontal">
                ...
                <dd>{{ optional($category->category)->id }}</dd>
