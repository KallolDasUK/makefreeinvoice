...
<div class="card">
    ...
    <div class="card card-custom overflow-hidden mx-auto" style="width: 70%">
        <div class="card-body p-0">
            ...
            <div class="row justify-content-center bgi-size-cover bgi-no-repeat py-8 px-8 py-md-27 px-md-0" style="background-image: url(https://preview.keenthemes.com/metronic/theme/html/demo2/dist/assets/media/bg/bg-6.jpg);">
                <div class="col-md-9">
                    <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                        ...
                        <div class="d-flex flex-column align-items-md-end px-0">
                            <!--begin::Logo-->
                            <a href="#" class="mb-5">
                                <img src="/metronic/theme/html/demo2/dist/assets/media/logos/logo-light.png" alt="">
                            </a>
                            <!--end::Logo-->
