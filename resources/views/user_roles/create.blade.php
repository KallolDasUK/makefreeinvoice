...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('user_roles.user_role.store') }}" accept-charset="UTF-8"
                  id="create_user_role_form" name="create_user_role_form" class="form-horizontal">
                {{ csrf_field() }}
                @include ('user_roles.form', ['userRole' => null])
