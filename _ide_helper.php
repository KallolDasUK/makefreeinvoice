...
')
     ...
     */ 
         ...
         * 
         *
         * @param \LaravelDaily\Invoices\Classes\InvoiceItem $item
         ...
         * 
         *
         * @param \LaravelDaily\Invoices\Contracts\PartyContract $seller
         * @return \LaravelDaily\Invoices\Invoice 
         * @static 
         */ 
         ...
         * 
         *
         * @param \LaravelDaily\Invoices\Contracts\PartyContract $buyer
         * @return \LaravelDaily\Invoices\Invoice 
         * @static 
         */ 
