    ...
    <div class="card card-default">
        ...
        <div class="card-heading clearfix">
            ...
            <div class="btn-group btn-group-sm float-right" role="group">
                ...
                </a> <a href="{{ route('journals.journal.index') }}" class="btn btn-success">
                    <span class="mdi mdi-view-list" aria-hidden="true"></span>
                    All Journals({{ \Enam\Acc\Models\Transaction::query()->where('txn_type',\Enam\Acc\Utils\VoucherType::$JOURNAL)->count() }})
                </a>
            </div>
                                ...
                                <td>
                                    <div class="row float-right">
                                        ...
                                        <form class="col" method="POST"
                                              action="{!! route('journals.journal.restore', $transaction->id) !!}"
