    ...
    <div class="card card-default">
        <div class="card-heading clearfix">
            ...
            <div class="float-right">
                ...
                <form method="POST" action="{!! route('journals.journal.destroy', $transaction->id) !!}"
                    ...
                    <div class="btn-group btn-group-sm" role="group">
                        ...
                        <a href="{{ route('journals.journal.create') }}" class="btn btn-success mr-2"
                        ...
                        <button type="submit" class="btn btn-danger" title="Delete Transaction"
                                onclick="return confirm(&quot;Click Ok to delete journal.?&quot;)">
