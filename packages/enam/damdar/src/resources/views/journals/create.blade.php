    ...
    <div class="card card-default">
        ...
        <div class="card-heading clearfix">
            ...
            <div class="btn-group btn-group-sm float-right" role="group">
                <a href="{{ route('journals.journal.index') }}" class="btn btn-primary"
                   title="Show All Journal">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('journals.journal.store') }}"
            ...
            >
                ...
                <input type="text" name="txn_type" value="Journal" hidden>
