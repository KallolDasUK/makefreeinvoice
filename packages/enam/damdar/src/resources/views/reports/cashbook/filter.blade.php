...
@section('content')
    ...
    <form action="{{ route('accounting.report.cashbook.pdf') }}" method="get" target="_blank">
...
{{--                                            <input class="form-check-input" id="cashRadio" type="radio"--}}
{{--                                                   name="filter"--}}
{{--                                                   value="cash" checked>--}}
...
{{--                                        </div>--}}
{{--                                        <div class="col form-check">--}}
{{--                                            <input class="form-check-input" id="bankRadio" type="radio"--}}
{{--                                                   name="filter"--}}
{{--                                                   value="bank">--}}
...
{{--            </div>--}}
            ...
            <div class="col-lg-6 mx-auto col-xs-12 col-sm-12 col-md-12 mx-auto float-right pr-4">
                ...
                <a href="{{ route('accounting.report.cashbook') }}"
