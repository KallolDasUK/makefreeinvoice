    ...
    <div class="card card-default">
        ...
        <div class="card-heading clearfix">
            ...
            <div class="btn-group btn-group-sm float-right" role="group">
                <a target="_blank" href="{{ route('payments.payment.pdf',$transaction->id) }}"
                   class="btn btn-inverse-primary mr-2" title="Print Transaction">
                    <span class="mdi mdi-printer" aria-hidden="true"></span>
                    Print Payment
                </a>
                <a href="{{ route('payments.payment.index') }}" class="btn btn-primary mr-2"
                ...
                <a href="{{ route('payments.payment.create') }}" class="btn btn-success"
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('payments.payment.update', $transaction->id) }}"
                  id="edit_transaction_form" name="edit_transaction_form" accept-charset="UTF-8"
                  class="form-horizontal">
                {{ csrf_field() }}
                <input name="_method" type="hidden" value="PUT">
                @include ('acc::payments.form', [
