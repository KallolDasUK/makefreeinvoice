    ...
    <div class="card card-default">
        ...
        <div class="card-heading clearfix">
            ...
            <div class="btn-group btn-group-sm float-right" role="group">
                <a href="{{ route('contras.contra.trash') }}" class="btn btn-danger mr-2"
                ...
                </a> <a href="{{ route('contras.contra.index') }}" class="btn btn-success">
                    <span class="mdi mdi-view-list" aria-hidden="true"></span>
                    All Contras({{ \Enam\Acc\Models\Transaction::query()->where('txn_type',\Enam\Acc\Utils\VoucherType::$CONTRA)->count() }})
                </a>
            </div>
                                ...
                                <td>
                                    <div class="row float-right">
                                        ...
                                        <form class="col" method="POST"
                                              action="{!! route('contras.contra.restore', $transaction->id) !!}"
