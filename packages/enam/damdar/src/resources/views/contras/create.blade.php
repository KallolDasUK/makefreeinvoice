    ...
    <div class="card card-default">
        ...
        <div class="card-heading clearfix">
            ...
            <div class="btn-group btn-group-sm float-right" role="group">
                <a href="{{ route('contras.contra.index') }}" class="btn btn-primary"
                   title="Show All Contra">
        ...
        <div class="card-body">
            ...
            >
                ...
                <input type="text" name="txn_type" value="Contra" hidden>

                <div class="form-group">

                    <input class="btn btn-primary" type="submit" value="Add Contra">
