    ...
    <div class="card card-default">
        ...
        <div class="card-heading clearfix">
            ...
            <div class="btn-group btn-group-sm float-right" role="group">
                ...
                <a href="{{ route('contras.contra.trash') }}" class="btn btn-danger mr-2" title="Create New Payment">
                    <span class="mdi mdi-trash-can" aria-hidden="true"></span>
                    Trash({{\Enam\Acc\Models\Transaction::onlyTrashed()->where('txn_type',\Enam\Acc\Utils\VoucherType::$CONTRA)->count()}}
                    )
                </a>
                <a href="{{ route('contras.contra.create') }}" class="btn btn-success" title="Create New Contra">
                        ...
                        @foreach($transactions as $transaction)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST"
                                          action="{!! route('contras.contra.destroy', $transaction->id) !!}"
                                        ...
                                        <div class="btn-group btn-group-xs float-right" role="group">
                                            <a target="_blank"
                                               href="{{ route('contras.contra.pdf', $transaction->id ) }}"
                                               class="btn btn-inverse-primary mr-2" title="Print Transaction">

                                                <i class="mdi mdi-printer"></i>
                                            </a>
                                            <a href="{{ route('contras.contra.show', $transaction->id ) }}"
