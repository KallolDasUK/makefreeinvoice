    ...
    <div class="card card-default">
        ...
        <div class="card-heading clearfix">
            ...
            <div class="btn-group btn-group-sm float-right" role="group">
                <a href="{{ route('transactions.transaction.index') }}" class="btn btn-primary"
                   title="Show All Receive">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('transactions.transaction.store') }}"
            ...
            >
                ...
                <input type="text" name="txn_type" value="Receive" hidden>

                <div class="form-group">

                    <input class="btn btn-primary" type="submit" value="Add Receive">
