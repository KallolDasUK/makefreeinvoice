    ...
    <div class="card card-default">
        ...
        <div class="card-heading clearfix">
            ...
            <div class="btn-group btn-group-sm float-right" role="group">
                ...
                <a href="{{ route('transactions.transaction.create') }}" class="btn btn-success"
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('transactions.transaction.update', $transaction->id) }}"
                  id="edit_transaction_form" name="edit_transaction_form" accept-charset="UTF-8"
                  class="form-horizontal">
                {{ csrf_field() }}
                <input name="_method" type="hidden" value="PUT">
                @include ('acc::transactions.form', [
