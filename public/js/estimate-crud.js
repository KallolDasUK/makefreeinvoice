        ...
        submitHandler: function (form) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    ractive.set(`estimate_items.${i}.product_id`, response.id)
                    ractive.set(`estimate_items.${i}.price`, response.sell_price)
                    ractive.set(`estimate_items.${i}.unit`, response.sell_unit || 'unit')
                    ractive.set(`estimate_items.${i}.description`, response.description || '')
        ...
        submitHandler: function (form) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    ractive.set(`estimate_items.${i}.tax_id`, response.id)
